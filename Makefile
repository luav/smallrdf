...
INC = 
CFLAGS = -Wnon-virtual-dtor -Winit-self -Wcast-align -Wundef -Wfloat-equal -Wunreachable-code -Weffc++ -std=c++17 -Wmissing-include-dirs -Wzero-as-null-pointer-constant -fno-exceptions -fstack-protector -fstack-clash-protection -Werror=format-security -Wl,-z,defs -Wl,-z,now -Wl,-z,relro -Wl,-nostdlib
RESINC = 
LIBDIR = 
LIB = 
LDFLAGS = 
...
CFLAGS_RELEASE = $(CFLAGS) -fomit-frame-pointer -O3 -fPIC -shared -pipe -D_FORTIFY_SOURCE=1
...
CFLAGS_RELEASE_NATIVE = $(CFLAGS) -fomit-frame-pointer -O3 -shared -pipe -fpic -march=native -nodefaultlibs -DNDEBUG -D_FORTIFY_SOURCE=1
